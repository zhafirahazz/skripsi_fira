    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                    <h5 class="d-inline align-middle m-3"><b>Hasil Perhitungan Payback Period (PP) dengan Arus Kas Pertahun Berbeda</b></h5>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="pp" class="form-label">PP</label>
                                <input type="text" class="form-control" id="pp" placeholder="0" disabled>
                            </div>
                            <div class="mb-3">
